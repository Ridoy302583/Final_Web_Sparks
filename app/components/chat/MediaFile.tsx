...
interface HeaderProps{
    setFiles: (image: string | null) => void;
    handleClickOpenWhiteBoard:()=> void;
    handleCrawlerOpen:()=> void;
    setSignInOpen: (open: boolean) => void;
}

const MediaFile:React.FC <HeaderProps> = ({setFiles, handleClickOpenWhiteBoard, handleCrawlerOpen, setSignInOpen = () => {}}) => {
    ...
    }, [theme]); // This will run whenever theme chang
        ...
        <>
            ...
            <div className="justify-center w-full flex">
                <div className='flex flex-wrap gap-4 justify-center' style={{ minWidth: 900 }}>
                    <ProcessingCard title="From Figma/Image" subtitle="From Figma/Image" onClick={handleClick}>
                        {theme === 'light' ? (
                            <>
